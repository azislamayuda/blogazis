...
// Date: 2007-04-12
// ---------------------------------------------------
// Modified by Azis Lamayuda 
// www.azislamayuda.com
// desain tabel with bootstrap
...
// global variables
   ...
   var tocdiv = document.getElementById("lamayuda_toc"); //the toc container
...
// and displays the filtered list of posts
  // document.getElementById("lamayuda_toc").scrollTop = document.getElementById("lamayuda_toc").offsetTop;;
   postFilter = filter;
...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Displaying all <strong>' + postTitle.length + '</strong> posts<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Displaying <strong>' + numDisplayed + '</strong> posts labeled <mark>\'';
      tocNote += postFilter + '\'</mark> of <strong>'+ postTitle.length + '</strong> posts total<br/></span>';
   }
